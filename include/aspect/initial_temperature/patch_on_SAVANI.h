...
#ifndef _aspect_initial_temperature_patch_on_SAVANI_h
#define _aspect_initial_temperature_patch_on_SAVANI_h
...
namespace aspect
{
  namespace InitialTemperature
  {
     ...
     */
    template <int dim>
    class PatchOnSAVANI : public Utilities::AsciiDataInitial<dim>, public Interface<dim>
    {
      public:
        /**
         * Empty Constructor.
      ...
      private:
        /**
         * Declare a member variable of type SAVANIPerturbation that allows us to call
         * functions from SAVANI_perturbation.cc.
         */
        SAVANIPerturbation<dim> savani;
